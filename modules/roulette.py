    ...
    async def ruleta(self, ctx, apuesta: int = None, espacio: str = None):
        ...
        try:
            ...
            color_emoji = (
                ...
                else "🔴" if color_result == "red"
                else "🟢"
            )

            if gano:
                pago_total = apuesta * multiplicador
                ganancia_neta = pago_total - apuesta
                await settle_wager(wager["id"], pago_total)
                embed_resultado = discord.Embed(
                    ...
                    description=(
                        ...
                        f"Pago total: **{pago_total}** {COIN} (x{multiplicador}); "
                        f"ganancia neta: **+{ganancia_neta}** {COIN}."
                    ),
